...
#'
#' Creates an action button plus JavaScript to toggle a target element
#' into fullscreen mode.
#'
#' @param element_id HTML id of the container to expand.
#' @return A `tagList` with the button and script.
