#' Lot generation UI
#'
#' Provides sliders to parameterize the `LotGen` helper.
#'
#' @param id Shiny module namespace identifier.
#' @return A `tagList` containing slider inputs.
...
#' Lot generation server
#'
#' Runs the `LotGen` simulation whenever the user clicks simulate.
#'
#' @param id Shiny module namespace identifier.
#' @return Reactive expression with generated lots.
#' @author Vasco Cadavez (vcadavez@ipb.pt)
#' @author Ursula Gonzales-Barron (ubarron@ipb.pt)
