...
ca_Production_server <- function(input, output, session, suffix) {
  ...
  observe({
    ...
    inputListCaProd <- c("seed", "n_lots", "size_lot", "canta_weight",
                         "p_soil", "p_manure", "f_manure",
                         "c_soil_log_min", "c_soil_log_mode", "c_soil_log_max",
                         "q_soil_min", "q_soil_mode", "q_soil_max",
                         "p_foil", "r_foil", "f_irrig_raining",
                         "p_irrig_raining", "p_irrig", "c_irrig_log_min",
                         "c_irrig_log_max", "p_water_gain_min", "p_water_gain_max")
